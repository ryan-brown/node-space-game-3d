...
class Asteroid {
  ...
  static generateRandom(maxDistance, radiusMin, radiusMax, velocityMin, velocityMax, position = new THREE.Vector3()) {
    ...
    return new Asteroid(radius, position, velocity, rotationAxis, rotationSpeed);
  }
  ...
  serialize() {
    ...
    asteroidData += `${this.rotationAxis.x.toFixed(3)},${this.rotationAxis.y.toFixed(3)},${this.rotationAxis.z.toFixed(3)},`;
  ...
  static deserialize(data) {
    ...
    let rotationAxis = new THREE.Vector3(asteroidData[7], asteroidData[8], asteroidData[9]);
