...
const socket = ioClient.connect('localhost:8090');
...
document.getElementById('startButton').addEventListener('click', () => {
  ...
  socket.emit('start', {
    ...
    rotateAcceleration: document.getElementById('rotateAccelerationField')
      .value,
    maxHealth: document.getElementById('maxHealthField').value,
    passiveHealthRegen: document.getElementById('passiveHealthRegenField')
      .value,
